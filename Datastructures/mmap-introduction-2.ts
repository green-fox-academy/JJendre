...
for (let i = 0; i < Object.keys(Mymap).length; i++) {
  console.log(
    Object.values(Mymap)[i] + " (ISBN: " + Object.keys(Mymap)[i] + ")"
  );
}
...
//console.log(Mymap);
console.log(
  "Does key '478-0-61159-424-8' exists?: " +
    (Mymap["478-0-61159-424-8"] !== undefined)
);
console.log(
  "The value of key '978-1-60309-453-5' is: " +
    Object.values(Mymap["978-1-60309-453-5"]).join("")
);
