...
describe('extension test', () => {
  ...
  test('is vowel: a is true', function () {
    expect(isVowel('a')).toBeTruthy();
  });

  test('is vowel: u is true', function () {
    expect(isVowel('u')).toBeTruthy();
  });

  test('is vowel: k is false', function () {
    expect(isVowel('k')).toBeFalsy();
  });

  test('translate: bemutatkozik = bevemuvutavatkovozivik', function () {
    expect(translate('bemutatkozik')).toEqual('bevemuvutavatkovozivik');
  });

  test('translate: lagopus = lavagovopuvus ', function () {
